...
('binancepay_apikey', ''),
('binancepay_callback', NULL),
('binancepay_currency_code', 'USD'),
('binancepay_nonce', '4CuGDm2VFtbXbe7oEgoQr4N2RkL2ESj3'),
...
('paymentwall_callback', ''),
('paymentwall_card', '0'),
('paymentwall_country_code', 'CN'),
('paymentwall_currency_code', 'CNY'),
('paymentwall_key', ''),
('paymentwall_secret', ''),
('paymentwall_unionpay', '0'),
('paymentwall_wechat', '0'),
('paymentwall_widget', 'pw_1'),
('payoutlimit', '100'),
('payoutmethod', '1,2,3'),
('paypal_callback', ''),
('paypal_client', ''),
...
CREATE TABLE `coupon` (
  ...
  `usage_no` int(20) NULL DEFAULT '0',
...
(1, 'USD', 'US', '$', '0.16', 1, 1640304001),
(2, 'GBP', 'GB', '£', '0.12', 1, 1640304001),
(3, 'SGD', 'SG', '$', '0.21', 1, 1640304001),
(4, 'JPY', 'JP', '¥', '18.09', 1, 1640304001),
(5, 'CNY', 'CN', '¥', '1.00', 1, 1640304001),
(6, 'CAD', 'CA', '$', '0.20', 1, 1640304001),
(7, 'HKD', 'HK', '$', '1.22', 1, 1640304001),
(8, 'INR', 'IN', '₹', '11.69', 1, 1640304001),
(9, 'RUB', 'RU', '₽', '11.79', 1, 1640304001),
(10, 'TWD', 'TW', '$', '4.36', 1, 1640304001);
(11, 'GHS', 'GH', '$', '1.08', 1, 1640304001);
...
(1, 'ClashForAndroid', '1', '', '', 1640782058, 1, '/download/Clash.apk', 'config=clash', 'xmanager xmanager-clash'),
(2, 'AnXray', '1', '', '', 1640781966, 0, 'https://github.com/XTLS/AnXray/releases', 'config=anxray', 'icomoon icomoon-anxray'),
(3, 'V2rayNG', '1', '', '', 1640781981, 1, '/download/V2rayNG.apk', 'config=v2rayng', 'icomoon icomoon-v2rayng-new'),
(4, 'Surfboard', '1', '', '', 1640782058, 1, '/download/Surfboard.apk', 'surfboard=1', 'xmanager xmanager-surfboard'),
(5, 'ClashForWindows x64', '3', '', '', 1640782042, 1, '/download/Clashx64.exe', 'config=clash', 'xmanager xmanager-clash'),
(6, 'ClashForWindows x86', '3', '', '', 1640782254, 1, '/download/Clashx86.exe', 'config=clash', 'xmanager xmanager-clash'),
(7, 'V2rayN', '3', '', '', 1640782220, 1, '/download/V2rayN.zip', 'config=v2rayn', 'icomoon icomoon-v2rayn'),
(8, NULL, '3', NULL, NULL, NULL, 0, NULL, NULL, ''),
(9, 'Shadowrocket', '2', '', '', 1640782115, 1, 'https://itunes.apple.com/us/app/shadowrocket/id932747118?mt=8', 'config=shadowrocket', 'xmanager xmanager-shadowrocket'),
(10, 'QuantumultX', '2', '', '', 1640782106, 0, 'https://apps.apple.com/us/app/quantumult-x/id1443988620', 'config=quantumultx', 'xmanager xmanager-quantumultx'),
(11, NULL, '2', NULL, NULL, NULL, 0, NULL, NULL, ''),
(12, NULL, '2', NULL, NULL, NULL, 0, NULL, NULL, ''),
(13, 'ClashX', '4', '', '', 1640782131, 1, '/download/ClashX.dmg', 'config=1', 'xmanager xmanager-clash'),
(14, 'ClashForWindows(Mac)', '4', '', '', 1640782142, 1, '/download/Clash.dmg', 'config=1', 'xmanager xmanager-clash'),
(15, NULL, '4', NULL, NULL, NULL, 0, NULL, NULL, ''),
(16, NULL, '4', NULL, NULL, NULL, 0, NULL, NULL, ''),
(17, 'ClashForWindows(Linux)', '5', '', '', 1640782377, 1, '/download/Clash.tar.gz', 'config=clash', 'xmanager xmanager-clash'),
(18, 'Qv2ray', '5', '', '', 1640782379, 0, '/download/Qv2rayLinux.zip', 'config=1', 'icomoon icomoon-qv2ray'),
(19, NULL, '5', NULL, NULL, NULL, 0, NULL, NULL, ''),
(20, NULL, '5', NULL, NULL, NULL, 0, NULL, NULL, ''),
(21, 'XClient', '6', '', '', 1640782420, 1, 'https://github.com/xcode75/luci-app-xclient/releases', 'config=xclient', 'fad fa-paper-plane'),
(22, 'Openclash', '6', '', '', 1640782420, 0, '/download/openclash.apk', 'config=clash', 'xmanager  xmanager-clash'),
(23, NULL, '6', NULL, NULL, NULL, 0, NULL, NULL, ''),
(24, NULL, '6', NULL, NULL, NULL, 0, NULL, NULL, ''),
(25, 'TeamViewer (Windows)', '7', '', '', 1631802823, 0, 'https://dl.tvcdn.de/download/TeamViewer_Setup.exe', '', 'icomoon icomoon-teamviewer'),
